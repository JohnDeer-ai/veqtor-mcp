...
from .contracts import (
    ...
    inspection_returned_document_text_values,
...
DEFAULT_MAX_ITEMS = INSPECT_DEFAULT_MAX_ITEMS_V1
MAX_ITEMS = INSPECT_FIXED_LIMITS_V1["max_items"]
MAX_PHRASES = INSPECT_FIXED_LIMITS_V1["max_phrases"]
MAX_PHRASE_CHARS = INSPECT_FIXED_LIMITS_V1["max_phrase_chars"]
MAX_TOTAL_PHRASE_CHARS = INSPECT_FIXED_LIMITS_V1["max_total_phrase_chars"]
MAX_PARAGRAPH_TEXT_CHARS = INSPECT_FIXED_LIMITS_V1["max_paragraph_text_chars"]
MAX_RETURNED_TEXT_CHARS = INSPECT_FIXED_LIMITS_V1["max_returned_text_chars"]
MAX_INDEXED_PARAGRAPHS = INSPECT_FIXED_LIMITS_V1["max_indexed_paragraphs"]
MAX_AGGREGATE_TEXT_CHARS = INSPECT_FIXED_LIMITS_V1["max_aggregate_text_chars"]
MAX_LITERAL_MATCH_CANDIDATES = INSPECT_FIXED_LIMITS_V1["max_literal_match_candidates"]
MAX_LITERAL_OCCURRENCES_PER_CANDIDATE = INSPECT_FIXED_LIMITS_V1[
...
_STATIC_EXCLUDED_PARTS = INSPECT_FIXED_EXCLUDED_PARTS_V1
...
def _page_items(
    ...
    *,
    ...
    while position < len(items) and len(page) < max_items:
        item = items[position]
        text_values = inspection_returned_document_text_values(item)
    ...
    *,
    ...
    page, next_offset = _page_items(
        ...
        base_returned_text_chars=sum(
            len(value)
            for value in inspection_returned_document_text_values(
    ...
    result["coverage"] = {
        ...
        "included_parts": list(INSPECT_INCLUDED_PARTS_V1),
        "excluded_parts": list(snapshot.excluded_parts),
        "included_containers": list(INSPECT_INCLUDED_CONTAINERS_V1),
...
def _inspect_document_result(
    ...
    *,
    ...
    """Produce one public result from one exact DOCX snapshot read."""
...
def inspect_document(
    ...
    *,
    ...
    return _inspect_document_result(
        path,
        mode,
        phrases=phrases,
        match_basis=match_basis,
